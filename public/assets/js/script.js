  ...
  const animalObject = { name, species, diet, personalityTraits };
    fetch('/api/animals', {
      ...
      .then(response => {
        ...
        alert('Oh noes: ' + response.statusText);
      })
      .then(postResponse => {
        console.log(postResponse);
        alert('Thank you for donating an animal!');
      });
...
const handleZookeeperFormSubmit = event => {
  ...
  fetch('api/zookeepers', {
    ...
    .then(response => {
      ...
      alert('Oh lawd, you need to add something valid sweetie. This is why we got a: ' + response.statusText);
    })
    .then(postResponse => {
      console.log(postResponse);
